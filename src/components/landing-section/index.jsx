  ...
  return (
    <section id="landing" className="flex items-center p-10 gap-5">
      <div className="space-y-8">
        <h1 className="text-4xl md:text-6xl font-bold">¿Cómo podemos ayudarte hoy?</h1>
        ...
        <a href="https://wa.link/vlynwc" target="_blank">
          <Button className="w-full md:w-fit" size="lg" color="primary">Contáctanos</Button>
        </a>
      </div>
      <Image className="hidden rounded-full md:block" width={500} alt="consciencia hero image" src={heroImage} />
    </section>
  )
}
